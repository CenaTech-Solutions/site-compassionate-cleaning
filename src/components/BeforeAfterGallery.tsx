...
const transformations = [
  ...
  },
  {
    ...
    label: "Kitchen Area",
    caption:
      "Deep Transition Reset — surfaces cleared, dishes done, and dignity restored.",
  },
  {
    before: before3,
    after: after3,
      ...
      <div className="max-w-7xl xl:max-w-[1500px] 2xl:max-w-[1800px] mx-auto relative z-10 w-full">
        ...
        >
          ...
          <p className="text-navy-600/80 text-sm sm:text-base mt-4 leading-relaxed font-light">
            Every image here was shared with express client permission and
            gratitude. Drag the slider to reveal how a space can breathe again —
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/70 border border-rose-100/60 rounded-2xl px-5 py-3 shadow-xs">
            ...
            <p className="text-[11px] font-light text-navy-600/80 leading-relaxed">
              All spaces shown here belong to clients who chose to share their
              journey. We never photograph without consent — your story belongs
              to you.
            </p>
          </div>
        </motion.div>
